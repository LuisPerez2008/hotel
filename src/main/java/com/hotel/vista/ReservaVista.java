...
public class ReservaVista extends javax.swing.JFrame {
    ...
    public ReservaVista(Habitacion hab, Object user) {
        initComponents();
        setLocationRelativeTo(null);
        txtIdHabitacion.setText(String.valueOf(hab.getId()));
        txtNumhabitacion.setText(hab.getNumero());
        userLog = (Usuario) user;
        txtIdUsuario.setText(String.valueOf(userLog.getId()));
        ...
        } else if (hab.getId_tipo() == 2) {
            txtTipoHabitacion.setText("Doble");
        } else {
            txtTipoHabitacion.setText("Suite");
        }
        txtPiso.setText(hab.getPiso());
        if (hab.getEstado() == '1') {
            txtEstado.setText("Dsiponible");
    ...
    private void btnConfirmarReservaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarReservaActionPerformed
        if (validarceldas()) {
            ...
            if (pregunta == 0) {
                ...
                //Iniciar Detalle
                Reserva reser = reservaDao.ultimaReserva();
                txtIdReserva.setText(String.valueOf(reser.getId()));
